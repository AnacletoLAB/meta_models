...
from ..meta_layers import (Conv1DRectangularMetaLayer, FlattenMetaLayer,
...
class CNN1DMetaModel(MetaModel):
    ...
    The class implements a meta-model for flat CNN, useful for handling some
    kinds of sequential data. The meta-model is tipically composed of a few
